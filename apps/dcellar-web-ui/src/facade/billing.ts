...
export const getMonthlyBillByOwner = (
  params: GetMonthlyBillByOwnerParams,
): Promise<ErrorResponse | [GetMonthlyBillByOwnerResponse, null]> => {
...
export const getMonthlyBillByAddress = (
  params: GetMonthlyBillByAddressParams,
): Promise<ErrorResponse | [GetMonthlyBillByAddressResponse, null]> => {
...
export const getRealTimeBillCountByAddress = (
  params: GetRealTimeBillCountByAddressParams,
): Promise<ErrorResponse | [number, null]> => {
...
export const getRealTimeBillByAddress = (
  params: GetRealTimeBillListByAddressParams,
): Promise<ErrorResponse | [GetRealTimeBillListByAddressResponse, null]> => {
...
export const getRealTimeBillCountByOwner = (
  params: GetRealTimeBillByOwnerCountParams,
): Promise<ErrorResponse | [number, null]> => {
...
export const getRealTimeBillListByOwner = (
  params: GetRealTimeBillListByOwnerParams,
): Promise<ErrorResponse | [GetRealTimeBillListByOwnerResponse, null]> => {
