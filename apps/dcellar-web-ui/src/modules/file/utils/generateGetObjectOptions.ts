...
import { getObjectPropsType, requestParamsType, validateBucketName, validateObjectName } from "./file";
import { client } from "@/base/client";

export const generateGetObjectOptions = async (configParam: getObjectPropsType): Promise<requestParamsType> => {
  const {
    bucketName,
    objectName,
    endpoint,
