...
import { SETTLEMENT_FEE_DOC } from '@/modules/file/constant';
    ...
    <Tips
      ...
      tips={
        <Box>
          ...
          <Box textAlign={'right'}>
            <Link cursor={'pointer'} textDecoration={'underline'} href={SETTLEMENT_FEE_DOC} target='_blank'>Learn more</Link>
          </Box>
        </Box>
      }
    />
